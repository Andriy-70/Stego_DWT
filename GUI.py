...
class Window:
    ...
    def setup_ui(self):
        ...
        self.root.title("DWT Стеганографія")
        ...
        # Заголовок
        labelmain = ttk.Label(main_frame, text="DWT Стеганографія", font=("Arial", 26, "bold"), 
    ...
    def create_input_field(self):
        ...
        self.input_label = ttk.Label(
            self.input_frame, 
            text="Введіть текст для вбудування:", 
            bootstyle="primary"
    ...
    def create_modify_frame(self):
        ...
        brightness_label = ttk.Label(self.modify_frame, text="Яскравість", bootstyle="primary")
        ...
        contrast_label = ttk.Label(self.modify_frame, text="Контраст", bootstyle="primary")
        ...
        saturation_label = ttk.Label(self.modify_frame, text="Насиченість", bootstyle="primary")
        ...
        btn_apply = ttk.Button(button_frame, text="Застосувати", bootstyle="danger-outline", 
                            command=self.apply_image_changes)
        btn_apply.pack(side="left", padx=5)
        
        btn_save = ttk.Button(button_frame, text="Зберегти фото", bootstyle="success-outline",
                            command=self.save_image)
        btn_save.pack(side="left", padx=5)

    def create_image_display(self, frame):
        """ Створює область для відображення зображення """
        btn_select_image = ttk.Button(frame, text="Вибрати фото", bootstyle="primary-outline", 
    ...
    def select_image(self):
        ...
        file_path = filedialog.askopenfilename(title="Вибрати фото", 
    ...
    def embed_text(self, image_path, text):
        ...
        if not text:
            self.show_message("Помилка", "Будь ласка, введіть текст для вбудовування")
            return
            
        try:
            DWT.encode_message(image_path, text)
            self.show_message("Успіх", "Текст успішно вбудовано!")
        except Exception as e:
            self.show_message("Помилка", f"Не вдалося вбудувати текст: {str(e)}")
    ...
    def extract_text(self, image_path):
        ...
        try:
            ...
            if decoded_message:
                ...
                self.show_message("Інформація", "Приховане повідомлення не знайдено")
        except Exception as e:
            self.show_message("Помилка", f"Не вдалося витягнути текст: {str(e)}")
